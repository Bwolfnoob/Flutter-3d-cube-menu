...
List<Color> cores=[Color.fromRGBO(61,63,76,1),Color.fromRGBO(72,81,88,1),Color.fromRGBO(88,110,107,1),Color.fromRGBO(115,142,127,1),Color.fromRGBO(149,167,145,1),Color.fromRGBO(182,194,170,1),Color.fromRGBO(228,217,197,1),Color.fromRGBO(145,114,96,1),Color.fromRGBO(124,90,80,1),Color.fromRGBO(90,58,63,1),Color.fromRGBO(51,33,49,1),Color.fromRGBO(38,16,37,1),];
List<Face> faces=[
  Face(Page('Perfil',Icons.account_circle,cores[2]),calc1),
  Face(Page('Configurações',Icons.settings,cores[3]),calc2),
  Face(Page('Flutter',Icons.backup,cores[4]),calc3),
  Face(Page('Create',Icons.headset,cores[9]),calc4),
  Face(Page('Home',Icons.home,cores[8]),calc5),
  Face(Page('BRASIL',Icons.account_circle,cores[7]),calc6)
];
...
calc1()=>[x,0.0,x,y,0.0];
Matrix4 frente=Matrix4.identity()..setEntry(3,2,0.001)..translate(0.0,0.0,-h);
...
class _MyAppState extends State<MyApp> {
  @override
  Widget build(BuildContext context)=>MaterialApp(title:'3d Menu Cube',home:Menu());
}
...
class FacePageRoute extends PageRouteBuilder {
  ...
  FacePageRoute(this.face) :super(
    pageBuilder:(cxt,ani,sani) {
      return Scaffold(backgroundColor:cores[6],body:face.page.maior);
    },
    transitionsBuilder:(cxt,ani,sani,child) {
      return ScaleTransition(scale:ani,child:child,);
    }
  );
}